      ...
      {weekDays.map((date) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`min-h-4 text-[10px] font-medium leading-4 ${today ? "text-text-secondary" : "invisible"}`}
              aria-hidden={!today}
            >
              Hoje
            </span>
